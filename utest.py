...
class Test(unittest.TestCase):
    ...
    def testSize(self):
        a = whatsTheFile
        filepath = "./mydata.txt"
        self.assertEqual(a.wtf.to_md5(filepath), "2fd4e1c67a2d28fced849ee1bb76e7391b93eb12")

    def testSize(self):
        a = whatsTheFile
        filepath = "./mydata.txt"
        self.assertEqual(a.wtf.to_sha1(filepath) ,"9e107d9d372bb6826bd81d3542a419d6")
